...
<head>
    ...
    @endphp
    <title>Konfirmasi Perubahan Email - {{ $siteName }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 32px;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 13px; color: #475569; text-align: center; line-height: 1.6;">
                                Halo <strong>{{ $user->name }}</strong>, kami menerima permintaan perubahan alamat email untuk akun {{ $siteName }} Anda.
                            </p>

                            <p style="margin: 0 0 24px 0; font-size: 13px; color: #475569; text-align: center; line-height: 1.6;">
                                Silakan klik tombol verifikasi di bawah ini untuk mengonfirmasi bahwa alamat email ini benar milik Anda:
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; margin-bottom: 20px;">
                                <tr>
                                    <td style="padding: 14px; font-size: 11px; color: #64748b; line-height: 1.5; text-align: center;">
                                        🔒 Jika Anda tidak merasa melakukan permintaan ini, abaikan email ini. Alamat email akun Anda tidak akan berubah tanpa konfirmasi.
                                    </td>
                                </tr>
                            </table>

                            <p style="margin: 0; font-size: 11px; color: #94a3b8; text-align: center; word-break: break-all;">
                                Tautan bermasalah? Salin URL berikut ke browser Anda:<br>
